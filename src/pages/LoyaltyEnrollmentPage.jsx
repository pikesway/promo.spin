      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-400">
            Collect {threshold} stamps and earn <span className="text-white font-medium">{rewardName}</span>
          </p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`
                  w-full pl-11 pr-4 py-3 rounded-xl bg-white/5 border text-white placeholder-gray-500
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-white/30 text-white placeholder-gray-500 focus:outline-none transition-colors"
              />
            </div>
          </div>

          <label className={`flex items-start gap-3 p-3 rounded-xl cursor-pointer transition-colors ${formErrors.consent ? 'bg-red-500/10' : 'hover:bg-white/5'}`}>
            <div className="relative flex-shrink-0 mt-0.5">
              ...
              <div
                className={`
                  ...
                  ${formData.consent
                    ? 'border-transparent'
                    : formErrors.consent ? 'border-red-500' : 'border-white/30'
                  }
                `}
