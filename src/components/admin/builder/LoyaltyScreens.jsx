    ...
    <div className="space-y-6">
      <div className="bg-charcoal-800 rounded-lg border border-white/10">
        ...
        <div className="p-6">
          {activeScreen === 'enrollment' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <h3 className="text-base font-medium text-white">Enrollment Screen</h3>
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-sm text-gray-300">Enable enrollment</span>
                </label>
              </div>
              ...
              {loyaltyData.screens.enrollment.enabled ? (
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <label className="flex items-center gap-3 cursor-pointer">
                        ...
                        />
                        <span className="text-sm text-gray-400">Name (required)</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input
                          type="checkbox"
                ...
                <div className="p-4 bg-charcoal-900 rounded-lg border border-white/10 text-center">
          ...
          {activeScreen === 'reward' && (
            <div className="space-y-6">
              <h3 className="text-base font-medium text-white">Reward Unlocked Screen</h3>
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <span className="text-sm text-gray-400">days after earning</span>
                </div>
                <p className="text-xs text-gray-400 mt-1">
                ...
                >
                  <div className="backdrop-blur-sm bg-black/20 rounded-lg p-4">
                    ...
                    <div className="bg-white/10 backdrop-blur rounded-lg p-3 mb-4">
                      <p className="text-lg font-bold text-white">{loyaltyData.rewardName}</p>
                      {loyaltyData.rewardDescription && (
                        <p className="text-sm text-white/70">{loyaltyData.rewardDescription}</p>
                      )}
                    </div>
                    <button
