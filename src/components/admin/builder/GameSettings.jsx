...
const GameSettings = ({ gameData, onChange }) => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-6">Scheduling & Timezone</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-lg px-3 py-2"
            />
            <p className="text-xs text-gray-500 mt-1">Game will be inaccessible before this time.</p>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              End Date (Optional)
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-lg px-3 py-2"
            />
            <p className="text-xs text-gray-500 mt-1">Game will close after this time.</p>
          </div>
        </div>
      </div>

      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-6">Spin Limits</h2>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <label className="flex items-center cursor-pointer">
                ...
                />
                <span className="text-sm text-gray-700">One spin per user (Forever)</span>
              </label>
              ...
              <div className="flex flex-col">
                <label className="flex items-center cursor-pointer">
                  <input 
                    ...
                    className="mr-3 w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500"
                  />
                  <span className="text-sm text-gray-700">Time Limit (Reset after X hours)</span>
                </label>
                {gameData.settings?.spinLimit === 'time-limit' && (
                  <div className="ml-7 mt-2 p-3 bg-blue-50 rounded-lg border border-blue-100 w-full max-w-xs animate-fade-in-down">
                     ...
                     <div className="flex items-center space-x-2">
                       <input 
                         ...
                         className="w-20 border border-blue-200 rounded px-2 py-1 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                       />
              ...
              <div className="flex flex-col">
                <label className="flex items-center cursor-pointer">
                  <input 
                    ...
                    className="mr-3 w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500"
                  />
                  <span className="text-sm text-gray-700">Calendar Reset (Weekly/Monthly)</span>
                </label>
                {gameData.settings?.spinLimit === 'calendar-limit' && (
                  <div className="ml-7 mt-2 p-3 bg-blue-50 rounded-lg border border-blue-100 w-full max-w-sm animate-fade-in-down">
                     <div className="grid grid-cols-2 gap-3">
                       ...
                       {gameData.settings?.calendarResetFrequency !== 'monthly' ? (
                         <div>
                           <label className="block text-xs font-semibold text-blue-800 mb-1">Reset Day</label>
                           <select 
                         ...
                         <div>
                           <label className="block text-xs font-semibold text-blue-800 mb-1">Day of Month</label>
                           <select 
                             value={gameData.settings?.calendarResetDay || 1}
                             onChange={(e) => handleSettingsChange('calendarResetDay', parseInt(e.target.value))}
                             className="w-full border border-blue-200 rounded px-2 py-1 text-sm"
              ...
              <label className="flex items-center cursor-pointer">
                <input 
                  ...
                  className="mr-3 w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500"
                />
                <span className="text-sm text-gray-700">One spin per session (Browser Refresh)</span>
              </label>
              ...
              <label className="flex items-center cursor-pointer">
                <input 
                  ...
                  className="mr-3 w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500"
                />
                <span className="text-sm text-gray-700">Unlimited spins</span>
              </label>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-6">Access Control</h2>
        <div className="space-y-4">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-6">Game URLs & Sharing</h2>
        <div className="space-y-8">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Public Game URL
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="flex items-start space-x-4">
                <div ref={qrRef} className="p-2 bg-white border border-gray-200 rounded-lg inline-block">
            ...
            <div>
              ...
              <textarea 
                ...
                readOnly
                rows={4}
                className="w-full border border-gray-300 rounded-lg px-3 py-2 bg-gray-50 text-gray-600 font-mono text-xs"
              />
            </div>
          </div>
        </div>
