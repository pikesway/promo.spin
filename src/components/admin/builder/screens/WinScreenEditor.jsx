  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start space-x-3">
        <SafeIcon icon={FiInfo} className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
      ...
      <div className="space-y-4">
        <h4 className="font-medium text-gray-900">Animation Options</h4>
        <label className="flex items-center space-x-3">
          ...
          />
          <span className="text-sm text-gray-700">Show confetti animation</span>
        </label>
      </div>

      <div className="bg-gray-50 rounded-lg p-4">
        <h4 className="font-medium text-gray-900 mb-3">Mobile Preview (Default View)</h4>
        <div className="bg-white rounded-lg p-6 border border-gray-200 text-center relative overflow-hidden max-w-sm mx-auto">
