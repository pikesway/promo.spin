/*
  # Combined Migration Script for BizGamez Agency App

  Run this SQL in your Supabase SQL Editor to set up all tables, functions, and policies.

  URL: http://supabasekong-gk4oc8048csc0c0sowkkswg0.168.231.66.177.sslip.io
*/
